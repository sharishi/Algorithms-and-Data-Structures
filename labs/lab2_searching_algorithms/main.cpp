...
//
//    {
//        auto result = measureTimeAndResult(binary_search, cities, search_id);
//        //Binary search
//        std::cout << "Binary search: " << std::endl;
//        print_output(result, search_id);
//    }
//
//    {
//        auto result = measureTimeAndResult(linear_search, cities, search_id);
//        //Linear search
...
//    auto result_fibonacci_search = measureTimeAndResult(fibonacciSearch, cities, search_id, cities.size());
//    double time_fibonacci_search = result_fibonacci_search.first;
//    int ind_from_fibonacci_search = result_fibonacci_search.second;
//    City *ptr_to_city = &cities[ind_from_fibonacci_search];
